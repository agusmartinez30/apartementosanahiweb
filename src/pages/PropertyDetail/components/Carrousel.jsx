...
const Carrousel = ({ images }) => {
  ...
  useEffect(() => {
    const initalImage = images.slice(0, 1).map((i) => i)
    setSelectedImage(initalImage)
  }, [images])
        ...
        <Box>
          {
            selectedImage
              ...
              : <Image width={{ base: "450px", sm: "850px" }} height={{ base: "250px", sm: "400px" }} objectFit={"cover"} src={defaultImage} />
          }
